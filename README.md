...
<table>
  ...
  <tr valign="top">
    <td>
      <a href="https://akaustav.github.io/flexbugs/2.1.a-bug.html">2.1.a</a> &ndash; <em>bug</em><br>
...
<table>
  ...
  <tr valign="top">
    <td>
      <a href="https://akaustav.github.io/flexbugs/3.1.a-bug.html">3.1.a</a> &ndash; <em>bug</em><br>
      <a href="https://akaustav.github.io/flexbugs/3.1.b-workaround.html">3.1.b</a> &ndash; <em>workaround</em><br>
      <a href="https://akaustav.github.io/flexbugs/3.2.a-bug.html">3.2.a</a> &ndash; <em>bug</em><br>
      <a href="https://akaustav.github.io/flexbugs/3.2.b-workaround.html">3.2.b</a> &ndash; <em>workaround</em>
    </td>
...
By far the most common element to apply `min-height` to is the body element, and usually you're setting it to `100%` (or `100vh`). Since the body element will never have any content below it, and since having a vertical scroll bar appear when there's a lot of content on the page is usually the desired behavior, substituting `height` for `min-height` will almost always work as shown in demo [3.1.b](https://akaustav.github.io/flexbugs/3.1.b-workaround.html).

For cases where `min-height` is required, the workaround is to add a wrapper element around the flex container that is itself a flex container in the column direction. For some reason nested flex containers are not affected by this bug. Demo [3.2.a](https://akaustav.github.io/flexbugs/3.2.a-bug.html) shows a visual design where `min-height` is required, and demo [3.2.b](https://akaustav.github.io/flexbugs/3.2.b-workaround.html) shows how this bug can be avoided with a wrapper element.
...
<table>
  ...
  <tr valign="top">
    <td>
      <a href="https://akaustav.github.io/flexbugs/4.1.a-bug.html">4.1.a</a> &ndash; <em>bug</em><br>
      <a href="https://akaustav.github.io/flexbugs/4.1.b-workaround.html">4.1.b</a> &ndash; <em>workaround</em>
    </td>
    <td>Internet Explorer 10-11 (fixed in Edge)</td>
  </tr>
</table>
...
<table>
  ...
  <tr valign="top">
    <td>
      <a href="https://akaustav.github.io/flexbugs/5.1.a-bug.html">5.1.a</a> &ndash; <em>bug</em><br>
      <a href="https://akaustav.github.io/flexbugs/5.1.b-workaround.html">5.1.b</a> &ndash; <em>workaround</em>
    </td>
    <td>Internet Explorer 10-11 (fixed in Edge)</td>
  </tr>
</table>
...
Demo [5.1.a](https://akaustav.github.io/flexbugs/5.1.a-bug.html) contains an image whose height is 200 pixels and whose width is 500 pixels. Its container, however, is only 300 pixels wide, so after the image is scaled to fit into that space, its computed height should only be 120 pixels. The text quoted above does not make it clear as to whether the flex item's min-content size should be based the image's actual height or scaled height.
...
<table>
  ...
  <tr valign="top">
    <td>
      <a href="https://akaustav.github.io/flexbugs/7.1.a-bug.html">7.1.a</a> &ndash; <em>bug</em><br>
      <a href="https://akaustav.github.io/flexbugs/7.1.b-workaround.html">7.1.b</a> &ndash; <em>workaround</em><br>
      <a href="https://akaustav.github.io/flexbugs/7.1.c-workaround.html">7.1.c</a> &ndash; <em>workaround</em>
    </td>
    <td>Internet Explorer 10-11 (fixed in Edge)</td>
  </tr>
</table>
...
IE 10-11 always assume a content box model when using `flex-basis` to determine a flex item's size, even if that item is set to `box-sizing: border-box`. Demo [7.1.a](https://akaustav.github.io/flexbugs/7.1.a-bug.html) shows that an item with a `flex-basis` value of `100%` will overflow its container by the amount of its border plus its padding.
...
1. Instead of setting an explicit `flex-basis` value, use `auto`, and then set an explicit width or height. Demo [7.1.b](https://akaustav.github.io/flexbugs/7.1.b-workaround.html) shows this.
2. Use a wrapper element that contains no border or padding so it works with the content box model. Demo [7.1.c](https://akaustav.github.io/flexbugs/7.1.c-workaround.html) show this.
